 ...
 (function ($) {
  ...
  const Component = function (container) {
		...
		this.result2Content = '<div class="new_revision checker_p">Nintendo Switch Lite прошивается только с помощью чипа SX Lite</div><p class="checker_p"><strong>Подробнее про чипы <a href="https://switch.customfw.xyz/modchip">в руководстве</a>. Там же можно сделать заказ.</strong></p>';
