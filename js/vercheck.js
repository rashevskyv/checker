function checkSerial() {
        ...
        if (x.validity.valid && x.value.length > 8) {
            ...
            var new_revision='<div class="new_revision checker_p">Ваша приставка новой ревизии и прошивается только с помощью чипа SX или HWFLY</div><p class="checker_p"><strong>Подробнее про чипы <a href="https://switch.customfw.xyz/modchip">в руководстве</a>. Там же можно сделать заказ.</strong></p>';

            var unknown='<div class="unknown checker_p">Нет информации по введённому серийному номеру</div><p class="checker_p">Проверьте, правильно ли вы ввели серийный номер</p><p class="checker_p">Если серийный номер всё-таки введён верно, значит серийников такого типа ещё нет в нашей базе. Возможно, приставка выпускалась эксклюзивно для китайского региона. </p><p class="checker_p">В любом случае, если серийник введён верно, то вашу приставку нельзя прошить с помощью <a class="checker_a" href="http://switch.customfw.xyz/fusee-gelee">Fusée Gelée</a>. Если это ваш случай, то для вашей приставки подойдёт <strong>чип SX Core.</strong></p><p class="checker_p"><strong>Подробнее про чипы <a href="https://switch.customfw.xyz/modchip">в руководстве</a>. Там же можно сделать заказ.</strong></p>';
