function checkSerial() {
        ...
        if (x.validity.valid && x.value.length > 8) {
            ...
            var new_revision='<div class="new_revision checker_p">Ваша приставка новой ревизии и прошивается только с помощью чипа SX Core</div><p class="checker_p"><strong>Подробнее про чипы <a href="https://switch.customfw.xyz/modchip">в руководстве</a>. Там же можно сделать заказ.</strong></p>';
